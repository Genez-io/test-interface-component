...
interface SelectorProps extends SelectProps<Option, boolean> {
  placeholder?: string;
  defaultValue?: Option;
  value?: Option;
  options: Option[];
...
const getCustomStyles = (theme: DefaultTheme, variant?: keyof Theme["colors"]): StylesConfig<Option, boolean> => ({
  control: (provided) => ({
    ...provided,
    outline: "none",
...
const StyledSelect = styled(Select<Option, boolean>)`
  width: 100%;
  font-family: inherit;
`;
