...
class e {
    ...
    if (!this.isServer && this.isVisible) {
      ...
      t &&
        (function (t) {
          ...
          return (
            e ||
              ((e = fetch(t, { cache: "force-cache" }).then((t) => (t.ok ? t.text() : Promise.resolve(null)))),
              i.set(t, e)),
            e
          );
        })(t).then((t) => {
          this.svgContent = (function (t, e, i) {
            if (e) {
              ...
              for (let t = n.childNodes.length - 1; t >= 0; t--)
                "svg" !== n.childNodes[t].nodeName.toLowerCase() && n.removeChild(n.childNodes[t]);
              ...
              if (
                ...
                (function t(e) {
                  if (1 === e.nodeType) {
                    ...
                    for (i = 0; i < e.childNodes.length; i++) if (!t(e.childNodes[i])) return !1;
                  }
                  return !0;
                })(o))
              )
  ...
  hostData() {
    return {
      role: "img",
      class: Object.assign({}, ((t = this.color), t ? { "ion-color": !0, [`ion-color-${t}`]: !0 } : null), {
...
function s(t, e, i, s) {
  return (
    ...
    i && "ios" === e
      ...
      : s && "md" === e
        ? (t = s.toLowerCase())
        : t && ((t = t.toLowerCase()), /^md-|^ios-|^logo-/.test(t) || (t = `${e}-${t}`)),
    "string" != typeof t || "" === t.trim() ? null : "" !== t.replace(/[a-z]|-|\d/gi, "") ? null : t
  );
}
function n(t) {
