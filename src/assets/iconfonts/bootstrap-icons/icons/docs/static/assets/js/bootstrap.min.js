...
!(function (t, e) {
  ...
  class lt extends M {
      ...
      for (let s = 0, i = e.length; s < i; s++) {
        ...
        if (e[s].classList.contains("show")) {
          ...
          P.trigger(e[s], "hide.bs.dropdown", n).defaultPrevented ||
            ("ontouchstart" in document.documentElement &&
              [].concat(...document.body.children).forEach((t) => P.off(t, "mouseover", null, function () {})),
    ...
    static dataApiKeydownHandler(t) {
      ...
      if ("Escape" === t.key)
        return (
          (this.matches('[data-bs-toggle="dropdown"]') ? this : U.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(),
          void lt.clearMenus()
        );
    ...
    setElementContent(t, e) {
      if (null !== t)
        return "object" == typeof e && c(e)
          ...
          : void (this.config.html
              ? (this.config.sanitize && (e = Et(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
  ...
  class Ht extends M {
    ...
    _activate(t) {
      ...
      s.classList.contains("dropdown-item")
        ? (U.findOne(".dropdown-toggle", s.closest(".dropdown")).classList.add("active"), s.classList.add("active"))
