  ...
  (function (t, e, n, o) {
    ...
    function c(t, e, n, o) {
      ...
      i &&
        ((o = i["s-ld"] || i.$activeLoading) &&
          ...
          o.length || (i["s-init"] && i["s-init"](), i.$initLoad && i.$initLoad())),
        t.s.delete(e));
    }
    function l(t, e) {
      let n,
      ...
      for (; B.length > 0; ) {
        ...
        if (e && void 0 !== e.pop) for (c = e.length; c--; ) B.push(e[c]);
          ...
          "boolean" == typeof e && (e = null),
            (s = "function" != typeof t) &&
              (null == e ? (e = "") : "number" == typeof e ? (e = String(e)) : "string" != typeof e && (s = !1)),
            s && r
    ...
    function d(t, e, n, o, i, r) {
      if ((t.f.delete(e), !t.a.has(e))) {
        if (((o = t.d.get(e)), (n = !o))) {
          if (((i = t.s.get(e)) && i.$rendered && (i["s-rn"] = !0), i && !i["s-rn"]))
            return (
              (i["s-rc"] = i["s-rc"] || []).push(() => {
                d(t, e);
              }),
          ...
          o = (function s(t, e, n, o, i, r, c) {
            try {
              (function l(t, e, n, o, i, r, s) {
                ...
                t.m.has(n) || t.m.set(n, {}),
                ((r = Object.assign({ color: { type: String } }, e.properties)).mode = {
                  type: String,
                }),
                r))
                  m(t, r[s], n, o, s, i);
    ...
    function p(t, e, n, o) {
      ...
      try {
        o ? e["s-init"]() : (n.componentDidUpdate && n.componentDidUpdate(), j(t.W.get(e))),
    ...
    function m(t, e, n, o, i, r, c, l) {
      if (e.type || e.state) {
        ...
        e.state ||
          ...
          n.hasOwnProperty(i) && (void 0 === f[i] && (f[i] = s(e.type, n[i])), "mode" !== i && delete n[i])),
    ...
    function y(t, e, n, o, i) {
      ...
      (s && (!n || "false" === n)) || i
        ? r
          ...
          : t.removeAttribute(e)
        : "function" != typeof n && (s && (n = ""), r ? t.setAttributeNS(z, D(e), n) : t.setAttribute(e, n));
    }
      ...
      if ("class" !== n || r)
        if ("style" === n) {
          ...
          if (
            ...
            "type" !== n &&
            !r &&
            (n in e || (-1 !== ["object", "function"].indexOf(typeof i) && null !== i))
          ) {
            const o = t.b(e);
            o && o.N && o.N[n]
              ? (g(e, n, i), s && o.N[n].q && y(e, o.N[n].I, i, 3 === o.N[n].B, null == i))
              : "ref" !== n && (g(e, n, null == i ? "" : i), (null != i && !1 !== i) || t.j.H(e, n));
          } else null != i && "key" !== n ? y(e, n, i) : (r || (t.j.F(e, n) && (null == i || !1 === i))) && t.j.H(e, n);
        else
          (n = D(n) in e ? D(n.substring(2)) : D(n[2]) + n.substring(3)), i ? i !== o && t.j.U(e, n, i) : t.j.z(e, n);
      else if (o !== i) {
        const t = w(o),
          n = w(i),
    ...
    function k(t, e, n, o, i) {
      ...
      for (i in c)
        (i in s && c[i] === ("value" === i || "checked" === i ? r[i] : s[i])) || $(t, r, i, s[i], c[i], o, n.l);
    }
    function M(t, e) {
      function n(i, r, s, c, l, f, p, b, y) {
        if (
          ((b = r.vchildren[s]),
          u || ((m = !0), "slot" === b.vtag && (d && e.O(c, d + "-slot", ""), b.vchildren ? (b.Q = !0) : (b.Z = !0))),
          L(b.vtext))
        )
          b.c = e.G(b.vtext);
        else if (b.Z) b.c = e.G("");
          ...
          if (
            ((f = b.c =
              Q || "svg" === b.vtag ? e.J("http://www.w3.org/2000/svg", b.vtag) : e.K(b.Q ? "slot-fb" : b.vtag)),
            ...
            for (l = 0; l < b.vchildren.length; ++l)
              (p = n(i, b, l, f)) &&
                (L(a) && 3 === p.nodeType && !p["s-cr"] && e.V(f, e.X("s." + a + "." + l)),
                e.V(f, p),
                L(a) && 3 === p.nodeType && !p["s-cr"] && (e.V(f, e.X("/")), e.V(f, e.G(" "))));
          "svg" === b.vtag && (Q = !1);
        }
        return (
          (b.c["s-hn"] = v),
          (b.Q || b.Z) &&
            ...
            (b.c["s-cr"] = h),
            (b.c["s-sn"] = b.vname || ""),
            (y = i && i.vchildren && i.vchildren[s]) && y.vtag === b.vtag && i.c && o(i.c)),
          b.c
        );
      }
      function o(n, i, r, s) {
        ...
        for (r = f.length - 1; r >= 0; r--)
          (s = f[r])["s-hn"] !== v &&
            s["s-ol"] &&
            (e.tt(s), e.et(l(s), s, c(s)), e.tt(s["s-ol"]), (s["s-ol"] = null), (m = !0)),
            i && o(s, i);
        t.Y = !1;
      }
      function i(t, o, i, r, s, l, f, u) {
        const a = t["s-cr"] || t.$defaultHolder;
        for ((f = (a && e.nt(a)) || t).shadowRoot && e.ot(f) === v && (f = f.shadowRoot); s <= l; ++s)
          r[s] && (u = L(r[s].vtext) ? e.G(r[s].vtext) : n(null, i, s, t)) && ((r[s].c = u), e.et(f, u, c(o)));
      }
      function r(t, n, i, r) {
      ...
      return function b(y, $, w, g, M, j, C, O, x, N, W, E) {
        if (
              ...
              L(a.vtext)
                ...
                : ("slot" !== a.vtag && k(t, u, a, Q),
                  L(m) && L(v)
                    ? (function h(t, u, a, d, p, m, v, b) {
                        ...
                        for (; y <= w && $ <= M; )
                          if (null == g) g = u[++y];
                            ...
                            ("slot" !== g.vtag && "slot" !== C.vtag) || o(e.nt(g.c)),
                              f(g, C),
                              e.et(t, g.c, e.st(k.c)),
                              (g = u[++y]),
                              (C = d[--M]);
                          else if (s(k, j))
                            ("slot" !== g.vtag && "slot" !== C.vtag) || o(e.nt(k.c)),
                              f(k, j),
                              e.et(t, k.c, g.c),
                              (k = u[--w]),
                              (j = d[++$]);
                    ...
                    : L(v)
                      ? (L(u.vtext) && e.rt(p, ""), i(p, null, a, v, 0, v.length - 1))
          ...
          for (
            (function t(n, o, i, r, s, c, l, u, a, d) {
              for (s = 0, c = (o = e._(n)).length; s < c; s++) {
                if ((i = o[s])["s-sr"] && (r = i["s-cr"]))
                  for (u = e._(e.nt(r)), a = i["s-sn"], l = u.length - 1; l >= 0; l--)
                    (r = u[l])["s-cn"] ||
                      r["s-nr"] ||
                      r["s-hn"] === i["s-hn"] ||
                      ((((3 === (d = e.ct(r)) || 8 === d) && "" === a) ||
                        ...
                        (1 === d && e.lt(r, "slot") === a)) &&
                        (f.some((t) => t.ft === r) || ((p = !0), (r["s-sn"] = a), f.push({ ut: i, ft: r }))));
                1 === e.ct(i) && t(i);
              }
            })(w.c),
              C = 0;
            ...
            (O = f[C]).ft["s-ol"] || (((x = e.G(""))["s-nr"] = O.ft), e.et(e.nt(O.ft), (O.ft["s-ol"] = x), O.ft));
    ...
    function C(t, e, n, o, i) {
      ...
      if (i && 1 === r) {
        ...
        3 === r &&
          ...
          "s" === (l = t.dt(s).split("."))[0] &&
          l[1] === o &&
          (((f = { vtext: t.dt(e) }).c = e), n.vchildren || (n.vchildren = []), (n.vchildren[l[2]] = f));
    }
    function O(t, e) {
      const n = t.b(e);
      n.pt &&
    ...
    function x(t, e) {
      ...
      const i = o.v,
          ...
          return Object.keys(t).reduce(
            (e, n) => {
              ...
              if (o.state) (i = "states"), (r.mt = o.watchCallbacks || []);
                ...
                i = "props";
                let t = "any";
                o.type && ((t = o.type), "function" == typeof o.type && (t = o.type.name)),
        ...
        l = i.events || [],
        f = Object.assign({ wt: i.is, gt: o.kt || "unknown", encapsulation: i.encapsulation || "none" }, r, {
    ...
    function N(t, e, n, o, i) {
      return (
        ...
        n["s-cr"] ||
          ...
          ((n["s-cr"] = t.G("")), (n["s-cr"]["s-cn"] = !0), t.et(n, n["s-cr"], t._(n)[0])),
        t.M || 1 !== e.encapsulation || "shadowRoot" in HTMLElement.prototype || (n.shadowRoot = n),
        1 === e.encapsulation && t.M && !n.shadowRoot && t.Ct(n, { mode: "open" }),
        (o = { Ot: n["s-id"], S: {} }),
        e.N &&
    ...
    function E(t, e, n, o) {
      return function () {
        ...
        return (function r(t, e, n) {
          ...
          const i = t.Lt.body;
          return i
            ? (o || (o = i.querySelector(n)), o || ((o = e[n] = t.K(n)), t.V(i, o)), o.componentOnReady())
            : Promise.resolve();
    ...
    (function Z(t, e, n, o, s, c) {
              ...
              U: (e, n, r, s, c, l, f, u) => {
                ...
                if (
                  ...
                  "string" == typeof l
                    ...
                    : "object" == typeof l
                      ? (d = l)
                      : (u = n.split(":")).length > 1 && ((d = i.Ht(e, u[0])), (n = u[1])),
                  !d)
                )
                  return;
                let m = r;
      ...
      (e.isServer = e.isPrerender = !(e.isClient = !0)),
        ...
        (e.emit = (t, n, o) => m.Ft(t, e.eventNameFn ? e.eventNameFn(n) : n, o)),
        (p.h = l),
        (p.Context = e);
                          ...
                          if (!e[o]) {
                            ...
                            e[o] = s;
                            {
                              ...
                              t.O(s, "data-tmpl-style-tag", e.t),
                                r && (o.push(` data-style-mode="${r}"`), t.O(s, "data-tmpl-style-mode", r)),
                                (2 === n || (1 === n && !t.M)) &&
                                  (o.push(' data-style-scoped="true"'), t.O(s, "data-tmpl-style-scoped", "true")),
                                o.push(">"),
                                o.push(i),
                                o.push("</style>"),
                                (s.innerHTML = o.join(""));
