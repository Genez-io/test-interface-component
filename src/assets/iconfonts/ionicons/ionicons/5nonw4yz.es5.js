                      ...
                      (function e(t) {
                        if (1 === t.nodeType) {
                          ...
                          for (var i = 0; i < t.attributes.length; i++) {
                            ...
                            if ("string" == typeof n && 0 === n.toLowerCase().indexOf("on")) return !1;
                          }
                          for (i = 0; i < t.childNodes.length; i++) if (!e(t.childNodes[i])) return !1;
                        }
                        return !0;
                      })(s))
                    )
  ...
  function r(e, t, i, n) {
    return (
      ...
      i && "ios" === t
        ...
        : n && "md" === t
          ? (e = n.toLowerCase())
          : e && ((e = e.toLowerCase()), /^md-|^ios-|^logo-/.test(e) || (e = t + "-" + e)),
      "string" != typeof e || "" === e.trim() ? null : "" !== e.replace(/[a-z]|-|\d/gi, "") ? null : e
    );
  }
  function o(e) {
