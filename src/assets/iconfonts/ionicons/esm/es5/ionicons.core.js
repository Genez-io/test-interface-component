...
function i(n, t) {
  for (var e, r, i = null, o = !1, u = !1, f = arguments.length; f-- > 2; ) R.push(arguments[f]);
  for (; R.length > 0; ) {
    var c = R.pop();
    if (c && void 0 !== c.pop) for (f = c.length; f--; ) R.push(c[f]);
      ...
      "boolean" == typeof c && (c = null),
        (u = "function" != typeof n) &&
          (null == c ? (c = "") : "number" == typeof c ? (c = String(c)) : "string" != typeof c && (u = !1)),
        u && o
  ...
  return "function" == typeof n
    ...
    : { vtag: n, vchildren: i, vtext: void 0, vattrs: t, vkey: e, vname: r, f: void 0, c: !1 };
}
function o(n) {
  return {
    vtag: n.vtag,
...
function c(n, t, e, r, i, o) {
  if ((n.a.delete(t), !n.l.has(t))) {
    if (((r = n.v.get(t)), (e = !r))) {
      if (((i = n.u.get(t)) && i.$rendered && (i["s-rn"] = !0), i && !i["s-rn"]))
        return (
      ...
      r = (function u(n, t, e, r, i, o, f) {
        try {
          (function c(n, t, e, r, i, o, u) {
            ...
            n.p.has(e) || n.p.set(e, {}),
            ((o = Object.assign({ color: { type: String } }, t.properties)).mode = {
              type: String,
            }),
            o))
              s(n, o[u], e, r, u, i);
...
function a(n, t, e, r) {
  ...
  try {
    r ? t["s-init"]() : (e.componentDidUpdate && e.componentDidUpdate(), g(n.T.get(t))),
...
function s(n, t, r, i, o, u, f, c) {
  if (t.type || t.state) {
    var a = n.p.get(r);
    t.state ||
      (!t.attr || (void 0 !== a[o] && "" !== a[o]) || ((f = u && u.N) && S((c = f[t.attr])) && (a[o] = e(t.type, c))),
      r.hasOwnProperty(o) && (void 0 === a[o] && (a[o] = e(t.type, r[o])), "mode" !== o && delete r[o])),
...
function p(n, t, e, r, i) {
  ...
  (u && (!e || "false" === e)) || i
    ? o
      ...
      : n.removeAttribute(t)
    : "function" != typeof e && (u && (e = ""), o ? n.setAttributeNS(I, W(t), e) : n.setAttribute(t, e));
}
function h(n, t, e, r, i, o, u) {
  if ("class" !== e || o)
    if ("style" === e) {
      for (var f in r) (i && null != i[f]) || (/-/.test(f) ? t.style.L(f) : (t.style[f] = ""));
      ...
      if (
        ...
        var c = n.m(t);
        c && c.C && c.C[e]
          ? (m(t, e, i), u && c.C[e].R && p(t, c.C[e].F, i, 3 === c.C[e].H, null == i))
          : "ref" !== e && (m(t, e, null == i ? "" : i), (null != i && !1 !== i) || n.k.q(t, e));
...
function b(n, t, e, r, i) {
  var o = 11 === e.f.nodeType && e.f.host ? e.f.host : e.f,
    u = (t && t.vattrs) || x,
    f = e.vattrs || x;
  for (i in u) (f && null != f[i]) || null == u[i] || h(n, o, i, u[i], void 0, r, e.c);
  for (i in f) (i in u && f[i] === ("value" === i || "checked" === i ? o[i] : u[i])) || h(n, o, i, u[i], f[i], r, e.c);
}
function w(n, t) {
  function e(i, o, u, f, c, v, y, m, w) {
    if (
      ((m = o.vchildren[u]),
      a || ((d = !0), "slot" === m.vtag && (l && t.O(f, l + "-slot", ""), m.vchildren ? (m.z = !0) : (m.Q = !0))),
      S(m.vtext))
    )
      m.f = t.Y(m.vtext);
    else if (m.Q) m.f = t.Y("");
      ...
      if (
        ((v = m.f = B || "svg" === m.vtag ? t.Z("http://www.w3.org/2000/svg", m.vtag) : t.G(m.z ? "slot-fb" : m.vtag)),
        ...
        S(s) &&
          t.O(
            ...
            s +
              ...
              u +
              ((function n(t) {
                if (t) for (var e = 0; e < t.length; e++) if ("slot" !== t[e].vtag || n(t[e].vchildren)) return !0;
                return !1;
              })(m.vchildren)
                ? ""
                : "."),
        ...
        for (c = 0; c < m.vchildren.length; ++c)
          (y = e(i, m, c, v)) &&
            (S(s) && 3 === y.nodeType && !y["s-cr"] && t.J(v, t.K("s." + s + "." + c)),
            t.J(v, y),
            S(s) && 3 === y.nodeType && !y["s-cr"] && (t.J(v, t.K("/")), t.J(v, t.Y(" "))));
      "svg" === m.vtag && (B = !1);
    }
    return (
      (m.f["s-hn"] = p),
      (m.z || m.Q) &&
        ...
        (m.f["s-cr"] = h),
        (m.f["s-sn"] = m.vname || ""),
        (w = i && i.vchildren && i.vchildren[u]) && w.vtag === m.vtag && i.f && r(i.f)),
      m.f
    );
  }
  function r(e, i, o, u) {
    ...
    for (o = a.length - 1; o >= 0; o--)
      (u = a[o])["s-hn"] !== p &&
        u["s-ol"] &&
        (t.nn(u), t.tn(c(u), u, f(u)), t.nn(u["s-ol"]), (u["s-ol"] = null), (d = !0)),
        i && r(u, i);
    n.V = !1;
  }
  function i(n, r, i, o, u, c, a, s) {
    var l = n["s-cr"] || n.$defaultHolder;
    for ((a = (l && t.en(l)) || n).shadowRoot && t.rn(a) === p && (a = a.shadowRoot); u <= c; ++u)
      o[u] && (s = S(o[u].vtext) ? t.Y(o[u].vtext) : e(null, i, u, n)) && ((o[u].f = s), t.tn(a, s, f(r)));
  }
  function o(n, e, i, o) {
  ...
  return function m(w, g, M, j, k, $, A, E, O, P, T, _) {
    if (
            ...
            : ("slot" !== l.vtag && b(n, s, l, B),
              S(p) && S(h)
                ? (function y(n, s, l, v, d, p, h, m) {
                    for (
                      var b = 0, w = 0, g = s.length - 1, M = s[0], j = s[g], k = v.length - 1, $ = v[0], A = v[k];
                      b <= g && w <= k;
                      ...
                      if (null == M) M = s[++b];
                        ...
                        ("slot" !== M.vtag && "slot" !== A.vtag) || r(t.en(M.f)),
                          a(M, A),
                          t.tn(n, M.f, t.un(j.f)),
                          (M = s[++b]),
                          (A = v[--k]);
                      else if (u(j, $))
                        ("slot" !== M.vtag && "slot" !== A.vtag) || r(t.en(j.f)),
                          a(j, $),
                          t.tn(n, j.f, M.f),
                          (j = s[--g]),
                          ($ = v[++w]);
                ...
                : S(h)
                  ? (S(s.vtext) && t.on(d, ""), i(d, null, l, h, 0, h.length - 1))
      ...
      for (
        (function n(e, r, i, o, u, f, c, a, s, l) {
          for (u = 0, f = (r = t.X(e)).length; u < f; u++) {
            if ((i = r[u])["s-sr"] && (o = i["s-cr"]))
              for (a = t.X(t.en(o)), s = i["s-sn"], c = a.length - 1; c >= 0; c--)
                (o = a[c])["s-cn"] ||
                  o["s-nr"] ||
                  o["s-hn"] === i["s-hn"] ||
                  ((((3 === (l = t.fn(o)) || 8 === l) && "" === s) ||
        ...
        (E = y[A]).an["s-ol"] || (((O = t.Y(""))["s-nr"] = E.an), t.tn(t.en(E.an), (E.an["s-ol"] = O), E.an));
      for (n.V = !0, A = 0; A < y.length; A++) {
        for (E = y[A], T = t.en(E.sn), _ = t.un(E.sn), O = E.an["s-ol"]; (O = t.ln(O)); )
          if ((P = O["s-nr"]) && P && P["s-sn"] === E.an["s-sn"] && T === t.en(P) && (P = t.un(P)) && P && !P["s-nr"]) {
            _ = P;
            break;
          }
...
function j(n, t) {
  ...
  var i = r.y,
      ...
      return Object.keys(n).reduce(
        function (t, e) {
          ...
          if (i.state) (r = "states"), (o.pn = i.watchCallbacks || []);
            ...
            r = "props";
            var u = "any";
            i.type && ((u = i.type), "function" == typeof i.type && (u = i.type.name)),
    ...
    c = i.events || [],
    a = Object.assign({ gn: i.is, Mn: r.jn || "unknown", encapsulation: i.encapsulation || "none" }, o, {
...
function k(n, t, e, r, i) {
  return (
    ...
    e["s-cr"] ||
      ...
      ((e["s-cr"] = n.Y("")), (e["s-cr"]["s-cn"] = !0), n.tn(e, e["s-cr"], n.X(e)[0])),
  ...
  return function () {
    ...
    return (function o(n, t, e) {
      var r = t[e],
        i = n.Dn.body;
      return i
        ? (r || (r = i.querySelector(e)), r || ((r = t[e] = n.G(e)), n.J(i, r)), r.componentOnReady())
        : Promise.resolve();
...
function E(t, e, r, o, u, c) {
          ...
          B: function (t, e, o, u, f, c, a, s) {
            ...
            if (
              ...
              "string" == typeof c
                ...
                : "object" == typeof c
                  ? (v = c)
                  : (s = e.split(":")).length > 1 && ((v = i.qn(t, s[0])), (e = s[1])),
              v)
            ) {
              var p = o;
              (s = e.split(".")).length > 1 &&
  ...
  (e.isServer = e.isPrerender = !(e.isClient = !0)),
    ...
    (l.h = i),
    (l.Context = e);
  var p = (r["s-defined"] = r.$definedCmps = r["s-defined"] || r.$definedCmps || {}),
    h = 0,
    y = {
      k: v,
      Bn: function m(n, t) {
    ...
    (y.A = function (t, e, r, i) {
      (function o(t, e, r, i) {
        var o = r.encapsulation,
          ...
          f = r.n + i.mode,
          c = r[f];
        if ((u && (i["s-sc"] = n(r, i.mode)), c || ((c = r[(f = r.n + _)]), u && (i["s-sc"] = n(r))), c)) {
          var a = e.Dn.head;
          if (e.j)
          ...
          if ((l || t.Un.set(a, (l = {})), !l[f])) {
            var v = void 0;
            if ((t._ ? (v = t._.zn(i, f, c)) : (((v = e.G("style")).innerHTML = c), (l[f] = !0)), v)) {
              ...
              e.tn(a, v, (d.length && d[d.length - 1].nextSibling) || a.firstChild);
            }
          }
        }
      })(t, e, r, i);
...
function O(n, e, r) {
  ...
  if (u.length) {
    ...
    (f.innerHTML = u.join() + "{visibility:hidden}." + o + "{visibility:inherit}"),
...
function applyPolyfills(n, t) {
  n.nt = (function () {
    ...
    function e() {
      for (var n = 0; n < b; n += 2) (0, P[n])(P[n + 1]), (P[n] = void 0), (P[n + 1] = void 0);
      b = 0;
    }
    function r(n, t) {
      var e = this,
    ...
    function v(n, t, e, r) {
      var i = n.ot,
        o = i.length;
      (n.it = null), (i[o] = t), (i[o + x] = e), (i[o + N] = r), 0 === o && n.tt && M(d, n);
    }
    function d(n) {
      var t = n.ot,
        e = n.tt;
      if (0 !== t.length) {
        for (var r, i, o = n.et, u = 0; u < t.length; u += 3) (r = t[u]), (i = t[u + e]), r ? p(e, r, i, o) : i(o);
        n.ot.length = 0;
      }
    }
    function p(n, t, e, r) {
      ...
      if (i) {
        ...
        if ((o === S ? ((a = !0), (u = o.error), (o.error = null)) : (f = !0), t === o))
          return void l(t, new TypeError("Cannot return same promise"));
      } else (o = r), (f = !0);
      t.tt === _ && (i && f ? c(t, o) : a ? l(t, u) : n === x ? s(t, o) : n === N && l(t, o));
    }
    function h(n) {
      ...
      D = (function () {
          ...
          (this.dt = n),
            ...
            m(t)
              ? ((this.ht = this.length = t.length),
                ...
                0 === this.length
                  ? s(this.pt, this.et)
                  : ((this.length = this.length || 0), this.yt(t), 0 === this.ht && s(this.pt, this.et)))
        ...
        return (
          ...
          (n.prototype.bt = function (n, t, e) {
            var r = this.pt;
            r.tt === _ && (this.ht--, n === N ? l(r, e) : (this.et[t] = e)), 0 === this.ht && s(r, this.et);
          }),
  ...
  var e = [];
  (n.customElements &&
    (!n.Element || (n.Element.prototype.closest && n.Element.prototype.matches && n.Element.prototype.remove))) ||
    e.push(import("./polyfills/dom.js")),
    ("function" == typeof Object.assign && Object.entries) || e.push(import("./polyfills/object.js")),
    (Array.prototype.find && Array.prototype.includes) || e.push(import("./polyfills/array.js")),
    (String.prototype.startsWith && String.prototype.endsWith) || e.push(import("./polyfills/string.js")),
